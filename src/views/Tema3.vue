...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-around.align-items-center
          .col-lg-2.col-sm-10
            figure
              img(src='@/assets/curso/temas/tema3/img1.svg', alt='Texto que describa la imagen').img-tarjeta-linea-1
          .col-lg-10.col-sm-10
    ...
    .row.justify-content-around.align-items-center
          .col-lg-6.mt-3
            figure
              img(src='@/assets/curso/temas/tema3/img2.png', alt='Texto que describa la imagen').img-tarjeta-linea-1
